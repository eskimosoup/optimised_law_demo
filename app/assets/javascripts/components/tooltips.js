...
$(function() {
  $('a[href="#no-link"], a[href="#invalid-link"]').addClass('invalid-link');
  $('.modal-call-to-action input[type=submit], .dropdown input[type=submit]').addClass('invalid-link').attr('disabled');
