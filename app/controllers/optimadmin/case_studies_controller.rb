module Optimadmin
  class CaseStudiesController < Optimadmin::ApplicationController
    ...
    edit_images_for CaseStudy, [[:image, { index: ['fill', 316, 164], show: ['fill', 165, 135], activity_stream: ['fill', 199, 155] }]]
  ...
  private
    ...
    def case_study_params
      params.require(:case_study).permit(:title, :summary, :image, :content, :date, :suggested_url, :display, :case_study_category_id, service_ids: [])
    end
  end
end
