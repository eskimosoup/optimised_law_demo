module Optimadmin
  ...
  private
    ...
    def service_params
      params.require(:service).permit(:service_category_id, :parent_id, :name, :image, :summary, :content, :suggested_url, :display, :leaflet, :remote_leaflet_url, :leaflet_cache, :remove_leaflet, related_service_ids: [])
    end
  end
end
