class ServicesController < ApplicationController
  ...
  def show
    ...
    @presented_service_team_members = BaseCollectionPresenter.new(collection: @service.team_members + @service.team_members + @service.team_members + @service.team_members + @service.team_members, view_template: view_context, presenter: TeamMemberPresenter)
